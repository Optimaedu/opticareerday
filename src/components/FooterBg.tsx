...
const FooterBg = () => {
  return (
				<svg className="min-w-1600 min-h-300" fill='#3D3D3D' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
					viewBox="0 0 670.4 96.9">
				<g>
					<path className="st0" d="M0,50.7 M670.4,50.5l-27.7-15.1c0,0,0-2,0.1-4c0.1-2,0.1-0.8,1-1.8c0.9-1,0.2,0,1-1.7c0.7-1.7,1,0.5,2.2,0.2
